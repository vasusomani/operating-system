...
void sjfScheduling(struct Process *processes, int n)
{
    ...
    while(p_compl!=n){
        ...
        processes[min_i].compl_time = curr_time + processes[min_i].burst_time;
        processes[min_i].is_completed = 1;
        p_compl++;
        processes[min_i].tat_time = processes[min_i].compl_time - processes[min_i].arr_time;
        processes[min_i].wait_time = processes[min_i].tat_time - processes[min_i].burst_time;
        curr_time += processes[min_i].burst_time;
    }
}
